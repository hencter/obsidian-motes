...
const zhCN: Dict = {
  ...
  "settings.editorMode.name": "编辑器模式",
  "settings.editorMode.desc": "原生模式使用 Obsidian 内置编辑器；切换后重开 Motes 视图生效。",
  "settings.editorMode.native": "Obsidian 原生编辑器（推荐）",
  "settings.editorMode.tiptap": "Tiptap 富文本编辑器",
  "settings.editorMode.textarea": "纯 Markdown 文本框",
...
const enUS: Dict = {
  ...
  "settings.editorMode.name": "Editor mode",
  "settings.editorMode.desc": "Native uses Obsidian's built-in editor. Reopen the Motes view after switching.",
  "settings.editorMode.native": "Obsidian native editor (recommended)",
  "settings.editorMode.tiptap": "Tiptap rich-text editor",
  "settings.editorMode.textarea": "Plain Markdown textarea",
